...
public class Employee {
	...
	public String toString() {
		return "Employee [id=" + id + ", name=" + name + ", salary=" + salary + ", permanent=" + permanent
				...
				+ ", getId()=" + getId() + ", getName()=" + getName() + ", getSalary()=" + getSalary()
				+ ", isPermanent()=" + isPermanent() + ", getDepartment()=" + getDepartment() + ", getSkills()="
				+ Arrays.toString(getSkills()) + ", getDateOfBirth()=" + getDateOfBirth() + ", getClass()=" + getClass()
